...
export const ITEMS: Item[] = [
  ...
  // --- Essential verbs -----------------------------------------------------
  {
    ...
    he: "יֵשׁ / אֵין",
    tr: "yesh / ein",
    fr: "il y a / il n'y a pas",
    en: "there is / there isn't",
    example: EX.yeshLi,
  },
  {
    id: "w-rotse",
  ...
  },
  {
    ...
    fr: "aussi",
    en: "also",
    example: { he: "גַּם אֲנִי", tr: "Gam ani", fr: "Moi aussi", en: "Me too" },
  },
  {
    id: "w-ken-lo",
    group: "connectors",
    ...
    .flatMap((item) => [
      {
        id: `${item.id}:he2m`,
        itemId: item.id,
        direction: "he2m" as Direction,
      },
      {
        id: `${item.id}:m2he`,
        itemId: item.id,
        direction: "m2he" as Direction,
      },
    ])
    .sort((a, b) => {
